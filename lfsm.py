...
from pygdsm.component_data import LFSM_FILEPATH
...
def convert_ra_dec_to_healpix(ra,dec,nside):
...
class LowFrequencySkyModel(BaseSkyModel):
    ...
    def generate(self, freqs, ra=None, dec=None):
        ...
        if ra is not None and dec is not None:
            pixels = convert_ra_dec_to_healpix(ra,dec,self.nside)
            map_out = map_out[pixels]
